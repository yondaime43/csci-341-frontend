...
const Doctors = () => {
    ...
    const getDoctors = async () => {
        const result = await axios.get(
            "https://csci-341-backend.herokuapp.com/doctors"
        );
    ...
    const addDoctor = async (e) => {
        ...
        if (isPost) {
            ...
            result = await axios.put(
                `https://csci-341-backend.herokuapp.com/doctors/${doctorEmail}`,
                userData
            );
        }
    ...
    const deleteDoctor = async (email) => {
        const result = await axios.delete(
            `https://csci-341-backend.herokuapp.com/doctors/${email}`
        );
        if (result.status == 200) {
        }
    };
                        ...
                        <form onSubmit={addDoctor}>
                            <FormControl isRequired={isPost}>
                                ...
                                <Button
                                    ...
                                    type="submit"
                                >
                                    {isPost ? "Add doctor" : "Update doctor"}
                                </Button>
                            </FormControl>
                        </form>
                    </ModalBody>
